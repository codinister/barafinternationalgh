  ...
  return (
    <div className="contactdetails">
      <div>
        ...
        <Contactbox desc={set[0]?.email} url="#" fa="envelope" />
      </div>

      <div>
        <Contactbox desc="Facebook" url={set[0]?.facebook} fa="facebook" />
        <Contactbox desc="Instagram" url={set[0]?.instagram} fa="instagram" />
        <Contactbox desc="Youtube" url={set[0]?.youtube} fa="youtube" />
      </div>
    </div>
  );
};
